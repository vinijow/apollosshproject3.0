#!/bin/bash
tput setaf 7 ; tput setab 4 ; tput bold ; printf '%33s%s%-12s\n' "Verificar data de expiração" ; tput sgr0
echo ""
tput bold ; echo "Lista com usuario e data de expiração:" ; tput sgr0
echo ""
tput setaf 4 ; tput bold ; read -p "Nome do usuário:  " usuario ; tput sgr0;
awk -F : '$3 >= 500 { print $1 }' /etc/passwd | grep $usuario | while read user
  do
