...
tput setaf 2 ; tput bold ; printf '%s' "criarteste " ; tput setaf 7 ; printf '%s' "- " ; tput setaf 3 ; echo "Criar testes de curtos prazos...." ; echo ""
tput setaf 2 ; tput bold ; printf '%s' "verdata " ; tput setaf 7 ; printf '%s' "- " ; tput setaf 3 ; echo "Verificar data de 1 unico usuário." ; echo ""
tput setaf 2 ; tput bold ; printf '%s' "limitar " ; tput setaf 7 ; printf '%s' "- " ; tput setaf 3 ; echo "Limitador de conexões SSH simultâneas a cada 2 minutos(deve ser executado em uma sessão screen)" ; echo ""
